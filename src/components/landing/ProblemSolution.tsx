  ...
  return (
    <section className="py-16 bg-[#1A1A1A]">
      <div className="max-w-[1100px] mx-auto px-6 md:px-12">
        ...
        >
          <h2 className="text-[32px] font-[800] text-white mb-3">Why auto-compound?</h2>
          <p className="text-[16px] text-white/70">
            Manual claiming costs you <span className="text-[#FF6B6B] font-bold">18.4%</span> of your potential yield.
          </p>
        </motion.div>
